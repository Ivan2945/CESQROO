  ...
  return (
    <div className="mt-3">
      <div className="mb-4 flex flex-wrap items-center gap-3">
        <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Calificación · {eventName}</h1>
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {pendingRows.map((r) => {
              ...
              return (
                <tr key={r.entryId} className={"border-b " + (r.scored ? "bg-blue-50" : "")}>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {committed.map((r) => {
                  ...
                  return (
                    <tr key={r.entryId} className={"border-b " + (s.rankSection === 1 ? "bg-emerald-50" : s.rankSection == null ? "text-slate-400" : "")}>
